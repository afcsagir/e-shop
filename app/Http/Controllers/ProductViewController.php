...
//		$varJSON = json_encode($variance);
		...
		$getSimilar = Product::where('category', $product->category)->inRandomOrder()->paginate(3);

		return view('product', ['product' => $product, 'attributes' => $attributes, 'variance' => $variance, 'getrevs' => $getrevs, 'getSimilar' => $getSimilar]);
	}
